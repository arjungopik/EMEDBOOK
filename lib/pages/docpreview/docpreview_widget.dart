...
import 'docpreview_model.dart';
export 'docpreview_model.dart';
...
class DocpreviewWidget extends StatefulWidget {
  ...
  @override
  _DocpreviewWidgetState createState() => _DocpreviewWidgetState();
}

class _DocpreviewWidgetState extends State<DocpreviewWidget> {
  late DocpreviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocpreviewModel());
  }
