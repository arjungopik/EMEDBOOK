...
export 'alldoctors_model.dart';

class AlldoctorsWidget extends StatefulWidget {
  const AlldoctorsWidget({Key? key}) : super(key: key);

  @override
  _AlldoctorsWidgetState createState() => _AlldoctorsWidgetState();
}

class _AlldoctorsWidgetState extends State<AlldoctorsWidget> {
  late AlldoctorsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlldoctorsModel());
  }
